...
[Fornax Science Console](https://science-console.fornax.sciencecloud.nasa.gov/) | [Fornax Demo Notebooks] (https://nasa-fornax.github.io/fornax-demo-notebooks/) | [Documentation](xref:fornax-docs) | [Fornax Community Forum](https://discourse.fornax.sciencecloud.nasa.gov/)

## How-to Notebooks

This collection houses hands-on, “how-to” notebooks for working effectively in the Fornax Science Console (ForSC).
Tutorials in this repo focus on topics common to many Fornax users.
These tutorials are designed for scientists.
They emphasize reliable, reproducible patterns and performance-aware practices.
For examples of how to do science workflows starting with an idea, working through the project, ending with a reproducible plot, see [Fornax Demo Notebooks] (https://nasa-fornax.github.io/fornax-demo-notebooks/).

This collection of shorter notebooks consists of howto examplesfully worked science use cases for all users.
